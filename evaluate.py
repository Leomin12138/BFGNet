...
def parse_args():
    ...
    # Network
    parser.add_argument('--network', metavar='N', type=str, nargs='+',default=["/home/leo/code/BF_GNet/log/epoch_17_iou_0.95"],
    ...
    parser.add_argument('--dataset-path', type=str,default="/home/leo/code/Cornell",
    ...
    parser.add_argument('--iou-eval', action='store_true',default="--iou-eval",
