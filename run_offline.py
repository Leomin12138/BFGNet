...
def parse_args():
    ...
    parser.add_argument('--network', type=str,default="/home/leo/code/BF_GNet/log/epoch_17_iou_0.95",
                        help='Path to saved network to evaluate')
    parser.add_argument('--rgb_path', type=str, default='/home/leo/code/Cornell/08/pcd0845r.png',
                        help='RGB Image path')
    parser.add_argument('--depth_path', type=str, default='/home/leo/code/Cornell/08/pcd0845d.tiff',
